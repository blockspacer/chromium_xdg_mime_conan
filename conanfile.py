...
class chromium_xdg_mime_conan_project(conan_build_helper.CMakePackage):
    name = "chromium_xdg_mime"
    ...
    description = "modified `xdg_mime` library from chromium"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["chromium_xdg_mime"]
        ...
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "xdg_mime", "compat"))
